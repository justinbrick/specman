...
- **Data-first contracts:** The [SpecMan Core](spec/specman-core/spec.md) specification nails down YAML schemas for workspaces, specs, implementations, and scratch pads so nothing depends on vibes.
