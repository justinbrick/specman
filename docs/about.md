...
1. **Data-first contracts:** The [SpecMan Core](../spec/specman-core/spec.md) specification defines exact YAML schemas for workspaces, specs, implementations, and scratch pads. Every downstream tool validates against these contracts, ending format guesswork.
