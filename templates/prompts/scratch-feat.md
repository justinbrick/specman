...
4. Summarize the feature goals from {{arguments}} inside Context plus Scope & Goals, grounding the work in {{context}} and {{dependencies}} where applicable, and convert the planned tasks into a concise checklist that links to `tasks.md` when present.
